    ...
    public class InflaterInputBuffer
    {
        ...
        public int ReadLeByte()
        {
            if (available <= 0)
            {
                ...
                if (available <= 0)
                {
                    throw new PiaException("EOF in header");
                }
            }
    ...
    public class InflaterInputStream : Stream
    {
        ...
        protected void Fill()
        {
            ...
            if (inputBuffer.Available <= 0)
            {
                ...
                if (inputBuffer.Available <= 0)
                {
                    throw new PiaException("Unexpected EOF");
                }
            }
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            {
                throw new PiaException("Need a dictionary");
            }
            ...
            while (true)
            {
                ...
                {
                    throw new PiaException("Dont know what to do");
                }
            }
